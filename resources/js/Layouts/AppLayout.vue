                ...
                <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="justify-center hidden mt-6 sm:flex sm:space-x-8 sm:-my-px sm:ms-10">
                                <SearchBar class="mt-4 ml-12" /> <!-- Agregué mt-4 directamente al SearchBar -->
                            </div>

                        </div>

                        <div class="justify-center hidden mt-6 sm:flex sm:space-x-8 sm:-my-px sm:ms-10">
                            <Menu class="mt-4 ml-12" />
                        </div>
